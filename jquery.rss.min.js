(function(d){var e=function(a,b,c,f){this.target=a;this.url=b;this.html=[];this.effectQueue=[];this.options=d.extend({ssl:!1,host:"www.feedrapp.info",limit:15,key:null,layoutTemplate:"<div>{entries}</div>",entryTemplate:'<div class="post"><a href="{url}"><div class="title">{title}</div><div class="clear">{teaserImage}<div class="url">{url}</div><div class="date">{date} - Posted by {author}</div><div class="desc">{shortBodyPlain}</div></div></a></div>',tokens:{},outputMode:"json",dateFormat:"DD MMM YYYY",dateLocale:"en",effect:"show",offsetStart:!1,offsetEnd:!1,error:function(){console.log("jQuery RSS: url doesn't link to RSS-Feed")},onData:function(){},
